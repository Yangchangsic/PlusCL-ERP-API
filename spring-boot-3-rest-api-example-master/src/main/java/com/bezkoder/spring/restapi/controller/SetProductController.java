...
@RestController
@RequestMapping("/api")
public class SetProductController {

    private static final Logger logger = LoggerFactory.getLogger(SetProductController.class);

    @Autowired
    ApiService apiService;

    @GetMapping("/set-product")
    @ResponseBody
    public String getDataForSetProduct(
