...
@RestController
@RequestMapping("/api")
public class SetHomeProductController {

    private static final Logger logger = LoggerFactory.getLogger(SetHomeProductController.class);

    @Autowired
    ApiService apiService;

    @GetMapping("/set-home-product")
    @ResponseBody
    public String getDataForSetHomeProduct(
    ...
    @GetMapping("/set-home-product-excel")
